This folder is for generating Java code to parse Module & process XML.

This should be performed when the xml change format (for example, their xsd have changed).
