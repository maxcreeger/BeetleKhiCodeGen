...
REM file. Uses the khiModule.xsd model file to generate
...
"C:\Program Files\Java\jdk1.8.0_45\bin\xjc.exe" -d result -p test.beetlekhi C:\Users\Marmotte\workspace\BeetleKhiCodeGen\resources\xsd\khiModule.xsd 